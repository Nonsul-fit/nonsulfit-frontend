  ...
  return (
    <div className="nf-page">
      ...
      <main>
        ...
        <section className="nf-section nf-partners" id="partners"><div className="nf-container"><div className="nf-section-head nf-reveal"><span className="nf-eyebrow">PARTNER PROGRAMS</span><h2>분석 이후, 이제 실제 준비를 시작하세요.</h2><p>논술핏에서 지원 전략을 확인했다면,<br />논술 전문 교육과 컨설팅을 통해 실제 준비까지 이어갈 수 있습니다.</p></div><div className="nf-partner-grid nf-reveal"><a className="nf-partner-card" href="https://kairosnonsul.com/" target="_blank" rel="noopener noreferrer"><div className="nf-partner-banner"><img src={kairosBanner} alt="카이로스 논술" /></div><div className="nf-partner-content"><span className="nf-sample nf-partner-category">오프라인 학원</span><h3>카이로스 논술</h3><p>대학별 논술 유형에 맞춘 실전 대비</p><span>자세히 보기 <i aria-hidden="true">→</i></span></div></a><a className="nf-partner-card" href="https://kyh-consulting.com/" target="_blank" rel="noopener noreferrer"><div className="nf-partner-banner"><img src={kimYoonHwanBanner} alt="김윤환 논구술 컨설팅" /></div><div className="nf-partner-content"><span className="nf-sample nf-partner-category">1:1 컨설팅</span><h3>김윤환 논구술 컨설팅</h3><p>학생별 맞춤 지원 전략 및 논구술 컨설팅</p><span>자세히 보기 <i aria-hidden="true">→</i></span></div></a><a className="nf-partner-card" href="https://nonsul-learn.com/" target="_blank" rel="noopener noreferrer"><div className="nf-partner-banner"><img src={nonsulLearnBanner} alt="논술런" /></div><div className="nf-partner-content"><span className="nf-sample nf-partner-category">온라인 강의</span><h3>논술런</h3><p>체계적인 논술 수업과 실전 훈련</p><span>자세히 보기 <i aria-hidden="true">→</i></span></div></a></div><p className="nf-partner-disclaimer">파트너 프로그램은 각 교육기관이 직접 운영하며,<br />논술핏과 별도의 서비스입니다.</p></div></section>
      ...
      <footer className="nf-footer"><div className="nf-container nf-footer-grid"><div><div className="nf-footer-logo"><img src={brandLogo} alt="논술핏" /></div><p>데이터 기반의 지능형 대입 논술 전략 파트너</p></div><div><h3>서비스</h3><button onClick={()=>scrollTo("report")}>분석 리포트</button><button onClick={()=>scrollTo("process")}>이용 방법</button><button onClick={()=>scrollTo("trust")}>분석 기준</button><button onClick={()=>scrollTo("report")}>샘플 리포트</button></div><div><h3>고객 지원</h3><button onClick={()=>scrollTo("faq")}>자주 묻는 질문</button><a href="http://pf.kakao.com/_Glxodn" target="_blank" rel="noopener noreferrer">문의하기</a><a href="http://pf.kakao.com/_Glxodn" target="_blank" rel="noopener noreferrer">공지사항</a></div><div><h3>정책</h3><a href="https://nonsulfit.notion.site/2d87fa182ebd434ca1cb8cb3c43dae4d" target="_blank" rel="noopener noreferrer">이용약관</a><a href="https://nonsulfit.notion.site/fb52ccb9ef694fa793daa7df00e76081" target="_blank" rel="noopener noreferrer">개인정보처리방침</a><a href="https://nonsulfit.notion.site/67289b950ca041128820fd3986c7db4f" target="_blank" rel="noopener noreferrer">이메일 무단수집거부</a></div></div><div className="nf-container nf-footer-details"><div className="nf-footer-business"><p><span>상호: 김윤환입시연구소</span><span>대표자: 김윤환</span><span>사업자등록번호: 511-95-06456</span></p><p>주소: 서울특별시 강남구 학동로2길 19, 2층2568호(논현동, 세일빌딩)</p><p><span>전화: 010-2179-5972</span><span>이메일: edunonsul@daum.net</span><span>통신판매업신고번호: 제2026-서울강남-00870호</span></p><p>개인정보관리책임자: 오동준 PM</p></div></div><div className="nf-container nf-footer-notice">논술핏의 분석 결과는 입시 지원을 위한 참고 자료이며 합격을 보장하지 않습니다. 대학별 전형 내용은 변경될 수 있으므로 최종 지원 전 대학 입학처의 공식 모집요강을 확인해야 합니다.<small>© 2026 NonsulFit. All rights reserved.</small></div></footer>
